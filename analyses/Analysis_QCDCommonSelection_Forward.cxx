...
#define Analysis_QCDCommonSelection_Forward_cxx

#include "Analysis_QCDCommonSelection_Forward.h"
#include "AnaConfig.h"
#include <TROOT.h>
#include <TH1F.h>
#include <TH2F.h>
...
///=========================================
void Analysis_QCDCommonSelection_Forward::WorkerBegin()
{
  if (Debug()) cout << "Analysis_QCDCommonSelection_Forward: DEBUG In WorkerBegin()" << endl;
  ...
  if (Debug()) cout << "Analysis_QCDCommonSelection_Forward: DEBUG Finish WorkerBegin()" << endl;
...
///=========================================
void Analysis_QCDCommonSelection_Forward::WorkerTerminate(){
...
///=========================================  
bool Analysis_QCDCommonSelection_Forward::ProcessEvent()
{
  if (Debug()) cout << "Analysis_QCDCommonSelection_Forward: DEBUG In ProcessEvent(): RunNumber = " << RunNumber() << "; Channel = " << ChannelNumber() << "; EventNumber = " << EventNumber() << endl;
 ...
 const static MomKey AntiKt4LCTopo("AntiKt4LCTopo"), AntiKt4TopoEM("AntiKt4TopoEM"),
  ...
  if(Debug()){
    cout << " At end of QCDCommonSelection_Forward: " << endl;
    Show();
  }
