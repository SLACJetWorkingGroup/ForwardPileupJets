...
#define Analysis_TopCommonSelectionForward_cxx

#include "Analysis_TopCommonSelectionForward.h"
#include "AnaConfig.h"
#include <TROOT.h>
#include <TH1F.h>
#include <TH2F.h>
...
///=========================================
void Analysis_TopCommonSelectionForward::WorkerBegin()
{
  if (Debug()) cout << "Analysis_TopCommonSelectionForward: DEBUG In WorkerBegin()" << endl;
  ...
  if (Debug()) cout << "Analysis_TopCommonSelectionForward: DEBUG Finish WorkerBegin()" << endl;
...
///=========================================
void Analysis_TopCommonSelectionForward::WorkerTerminate(){
...
///=========================================  
bool Analysis_TopCommonSelectionForward::ProcessEvent()
{
  if (Debug()) cout << "Analysis_TopCommonSelectionForward: DEBUG In ProcessEvent(): RunNumber = " << RunNumber() << "; Channel = " << ChannelNumber() << "; EventNumber = " << EventNumber() << endl;
