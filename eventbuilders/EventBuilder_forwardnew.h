...
// from TTree EventBuilder_forwardnew/EventBuilder_forwardnew
// found on file: NTUP_JETMET.543738._000084.root.2
//////////////////////////////////////////////////////////

#ifndef EventBuilder_forwardnew_h
#define EventBuilder_forwardnew_h
...
class EventBuilder_forwardnew : public EventBuilderBase {
public :
  ...
  vector<float> closeBy;
   ...
   EventBuilder_forwardnew(TTree * /*tree*/ =0);
   virtual ~EventBuilder_forwardnew();

   AnalysisBase* fEvt;

   MomentObj* barcode_link;

   ClassDef(EventBuilder_forwardnew,0);
...
#ifdef EventBuilder_forwardnew_cxx

Bool_t EventBuilder_forwardnew::Notify()
{
...
#endif // #ifdef EventBuilder_forwardnew_cxx
